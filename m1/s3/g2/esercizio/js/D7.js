...
function concatenare(str1,str2) {
  ...
  let risultante = prima + seconda;
  console.log(risultante.toUpperCase())

}

concatenare("ciao","alione")
/* ESERCIZIO 2
...
{
let arr = ["ciao", "lollone" ,"pitone"]
function number() {
let numerate = arr.map(num => arr.length)
